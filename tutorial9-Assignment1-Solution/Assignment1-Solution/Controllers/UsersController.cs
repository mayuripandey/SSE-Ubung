...
namespace BookmarkService.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public Bookmark[] GetBookmarks(string id)
        {
            return _bookmarkRepository.GetByUser("http://localhost:5000/users/" + id);
        }
        ...
        {
            bookmark.User = "http://localhost:5000/users/" + id;

            _bookmarkRepository.Create(bookmark);
            return Created("http://localhost:5000/bookmarks/" + bookmark.Id, bookmark);
        }
    }
}
